              ...
              >
                ...
                <nav className={`mobile-drawer sm-desktop:hidden ${mobileMenuOpen ? 'open' : ''}`} aria-label="Mobile navigation">
                  ...
                  <div className="mobile-drawer-footer">
                    <div className="mb-4 rounded-xl p-3 bg-[var(--site-soft)] border border-[var(--site-line)] flex flex-col gap-2.5">
                      {/* Language Switcher */}
                      <div className="flex items-center justify-between text-sm font-semibold" style={{ color: 'var(--site-text)' }}>
                        <span className="flex items-center gap-2 text-xs uppercase tracking-wider opacity-80">
                      ...
                      {/* Theme Toggle */}
                      <div className="flex items-center justify-between text-sm font-semibold pt-2 border-t border-[var(--site-line)]" style={{ color: 'var(--site-text)' }}>
                        <span className="flex items-center gap-2 text-xs uppercase tracking-wider opacity-80">
                          {theme === 'dark' ? (
                            <svg xmlns="http://www.w3.org/2000/svg" width="15" height="15" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" viewBox="0 0 24 24" className="text-amber-400">
                              <circle cx="12" cy="12" r="5"/><line x1="12" y1="1" x2="12" y2="3"/><line x1="12" y1="21" x2="12" y2="23"/><line x1="4.22" y1="4.22" x2="5.64" y2="5.64"/><line x1="18.36" y1="18.36" x2="19.78" y2="19.78"/><line x1="1" y1="12" x2="3" y2="12"/><line x1="21" y1="12" x2="23" y2="12"/>
                            </svg>
                          ) : (
                            <svg xmlns="http://www.w3.org/2000/svg" width="15" height="15" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" viewBox="0 0 24 24" className="text-indigo-500">
                              <path d="M21 12.79A9 9 0 1 1 11.21 3 7 7 0 0 0 21 12.79z"/>
                            </svg>
                          )}
                        ...
                        <button
                          type="button"
                          onClick={toggleTheme}
                          className="site-theme-toggle theme-toggle-modern flex items-center justify-center"
                          style={{ width: 34, height: 34, borderRadius: 10 }}
                          aria-label={theme === 'dark' ? t('lightTheme') : t('darkTheme')}
                          title={t('changeTheme')}
                        >
                          {theme === 'dark' ? (
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="none" stroke="currentColor" strokeWidth="2.2" strokeLinecap="round" strokeLinejoin="round" viewBox="0 0 24 24" className="text-amber-400"><circle cx="12" cy="12" r="5"/><line x1="12" y1="1" x2="12" y2="3"/><line x1="12" y1="21" x2="12" y2="23"/><line x1="4.22" y1="4.22" x2="5.64" y2="5.64"/><line x1="18.36" y1="18.36" x2="19.78" y2="19.78"/><line x1="1" y1="12" x2="3" y2="12"/><line x1="21" y1="12" x2="23" y2="12"/></svg>
                          ) : (
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="none" stroke="currentColor" strokeWidth="2.2" strokeLinecap="round" strokeLinejoin="round" viewBox="0 0 24 24" className="text-slate-700"><path d="M21 12.79A9 9 0 1 1 11.21 3 7 7 0 0 0 21 12.79z"/></svg>
                          )}
                        </button>
                      </div>
                    </div>
