            ...
            <footer className="site-footer-modern">
              <div className="site-footer-grid">
                ...
                <div>
                  ...
                  <Link href="/the-le">Tiêu chí &amp; Thể lệ</Link>
                  <Link href="/thoi-gian">Lịch trình sự kiện</Link>
                ...
                <div>
                  ...
                  <a href="mailto:media@huit.edu.vn">Liên hệ ban tổ chức</a>
                  <a href="https://huit.edu.vn" target="_blank" rel="noopener noreferrer">Cổng thông tin HUIT</a>
                </div>
